...
public class RepositoriesPresenterTest {
    ...
    public void setUp() throws Exception {
        ...
        RepositoriesRepository repository = new TestRepositoryImpl(generateRepositories(15));
        mPresenter = new RepositoriesPresenter(context, loaderManager, mView, repository);
    }
...
//        verify(mView).showRepositories(anyList());
    ...
    private class SuccessGithubService extends TestGithubService {
        ...
        @Override
        public Observable<List<Repository>> commits() {
    ...
    private class TestRepositoryImpl implements RepositoriesRepository {
        ...
        @NonNull
        @Override
        public Observable<List<Repository>> saveRepositories(List<Repository> repositories) {
